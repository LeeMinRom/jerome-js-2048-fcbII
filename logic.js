...
document.addEventListener("touchmove",(e) =>{
    ...
    e.preventDefault(); // disable the line scrolling.
}, {passive: false});

// actual receive swipe of user. listen for the touchend event on the entire document
document.addEventListener("touchend",(e) =>{
    // check if the element triggered the event has a class name title
    if(!e.target.className.includes("tile")){
        return // exit the function
    }
    // calculating the movement kung ano yung naging malaki yung difference
    // para malaman yung movement
